...
public class AudioClipRecorder
{
     ...
     */
    public int startRecordingForTime(int millisecondsPerAudioClip,
     ...
     */
    private int doRecording(final int sampleRate, int encoding,
            ...
            int bufferIncreaseFactor)
    {
        ...
        while (continueRecording)
        {
            ...
            // no errors, do processing
            {
                ...
                int vol = clipListener.heardFrequency(readBuffer, sampleRate);
